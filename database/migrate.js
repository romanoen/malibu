    ...
    for (const booking of bookings) {
      try {
        ...
        const bookingToSave = {
          ...
          stripeCheckoutSessionId: booking.stripeCheckoutSessionId || booking.stripe_checkout_session_id,
          stripePaymentIntentId: booking.stripePaymentIntentId || booking.stripe_payment_intent_id,
          stripePaymentStatus: booking.stripePaymentStatus || booking.stripe_payment_status,
          stripeSyncedAt: booking.stripeSyncedAt || booking.stripe_synced_at,
